...
class detailproduct {
	...
	def buttondetail() {
		WebUI.click(findTestObject('detail product/buttondetailProduk'))
	}

	@Then("succes detail product")
	def succesdetailproduct() {
		WebUI.getText(findTestObject('detail product/verifyBerhasil'))
	}
