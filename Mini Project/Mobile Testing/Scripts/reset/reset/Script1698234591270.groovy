...
Mobile.tap(findTestObject('Add items/Name'), 0)

Mobile.setText(findTestObject('Add items/Name'), 'aku', 0)

Mobile.tap(findTestObject('Add items/Quantity'), 0)

Mobile.setText(findTestObject('Add items/Quantity'), '10', 0)

Mobile.tap(findTestObject('reset/buttonreset'), 0)

Mobile.getText(findTestObject('verify reset'), 0)
