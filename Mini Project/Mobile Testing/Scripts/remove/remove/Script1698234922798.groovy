...
Mobile.doubleTap(findTestObject('datayangakandihapus'), 0)
...
//// Verifikasi elemen atau kondisi setelah tindakan swipe
//TestObject nextPageElement = new TestObject('NextPageObject')
// Gantilah "NextPageObject" dengan objek pengujian aktual yang ingin Anda verifikasi
// Tunggu hingga elemen muncul dalam jangka waktu tertentu (misalnya, 10 detik)
Mobile.waitForElementPresent(findTestObject('verifyremove'), 10)
